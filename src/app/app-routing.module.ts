...
import { ActivityDisplayComponentModule } from './components/activity-display/activity-display.component-module';
import { ActivityServiceModule } from './services/activity.service-module';

@NgModule({
  imports: [RouterModule.forRoot([{ path: 'product/:id', component: ProductDetailComponent }, { path: 'cat-fact', component: CatFactDisplayComponent }, { path: 'age/:name', component: AgeDisplayComponent }, { path: 'cart/:id', component: CartProductsComponent }, { path: 'user/:id', component: UserDetailsComponent }, { path: 'bored', component: ActivityDisplayComponent }]), ProductDetailComponentModule, ProductServiceModule, CatFactDisplayComponentModule, CatFactServiceModule, AgeDisplayComponentModule, AgeServiceModule, CartProductsComponentModule, CartServiceModule, UserDetailsComponentModule, UserServiceModule, ActivityDisplayComponentModule, ActivityServiceModule],
